import { default as friendsQuiz} from './questionsModule.js';
import { default as elephantQuiz} from './elephantQuizModule.js';
...
//Create a new button in html for the quiz
const friendsQuizButton = document.querySelector("#friendsQuiz");
friendsQuizButton.addEventListener("click", () => loadQuiz(friendsQuiz));
const elephantQuizButton = document.querySelector("#elephantQuiz");
elephantQuizButton.addEventListener("click", () => loadQuiz(elephantQuiz));
...
function loadQuiz(selectedQuiz) {
  ...
  currentQuiz.questions.forEach((question) => {
    ...
    startButton.addEventListener("click", () => {
      ...
      quizButtons.setAttribute("id", "hide");
    });
